...
export class SecurityService { //varuable global , necesita que se subscriban a ella
  //Arquitectura subcribe
  theUser = new BehaviorSubject<User>(new User); //arranca vacio
